...
public class TransportationC2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_transportation_c2);
        ...
        listViewCF1 = new ListViewCF(findViewById(R.id.listView1),3);
        listViewCF2 = new ListViewCF(findViewById(R.id.listView2),4);
        listViewCF3 = new ListViewCF(findViewById(R.id.listView3),5);
        listViewCF4 = new ListViewCF(findViewById(R.id.listView4),6);
        ...
        nextPageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(TransportationC2Activity.this, FoodC1Activity.class);
